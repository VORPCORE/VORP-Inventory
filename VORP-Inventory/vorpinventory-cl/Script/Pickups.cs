...
namespace VorpInventory
{
    public class Pickups : BaseScript
    {
        ...
        private async void DeadActions()
        {
            ...
            if (PluginManager.Config.DropOnRespawn.Money)
            {
        ...
        {
            await Delay(200);
            if (PluginManager.Config.DropOnRespawn.Items)
            {
            ...
            if (PluginManager.Config.DropOnRespawn.Weapons)
            {
        ...
        public static void ShowPickupPrompt()
        {
            PickPrompt = Function.Call<int>((Hash)0x04F97DE45A519419);
            long str = Function.Call<long>(Hash._CREATE_VAR_STRING, 10, "LITERAL_STRING", Common.GetTranslation("TakeFromFloor"));
            Function.Call((Hash)0x5DD02A8318420DD7, PickPrompt, str);
            Function.Call((Hash)0xB5352B7494A08258, PickPrompt, PluginManager.CONTROL_PICKUP);
            Function.Call((Hash)0x8A0FB4D03A630D21, PickPrompt, false);
            Function.Call((Hash)0x71215ACCFDE075EE, PickPrompt, false);
